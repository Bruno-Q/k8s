...
kubectl get csr
kubectl label node 192.168.197.200  node-role.kubernetes.io/master='master'
kubectl label node 192.168.197.200  node-role.kubernetes.io/node='node'
kubectl label node 192.168.197.201  node-role.kubernetes.io/node='node'
kubectl get nodes
